<template>
  <div class="diy-border-box-12" ref="borderRef">
...
const filterId = computed(() => `border-box-12-filterId-${Math.random().toString(36).substr(2, 9)}`)
...
.diy-border-box-12 .diy-border-svg-container {
  position: absolute;
  width: 100%;
  height: 100%;
  top: 0px;
...
.diy-border-box-12 .border-box-content {
  position: relative;
  width: 100%;
  height: 100%;
}
