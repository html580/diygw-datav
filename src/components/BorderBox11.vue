<template>
  <div class="diy-border-box-11" ref="borderRef">
...
const filterId = computed(() => `border-box-11-filterId-${Math.random().toString(36).substr(2, 9)}`)
...
.diy-border-box-11 .diy-border-svg-container {
  position: absolute;
  width: 100%;
  height: 100%;
  top: 0px;
...
.diy-border-box-11 .diy-border-svg-container > polyline {
  fill: none;
  stroke-width: 1;
}

.diy-border-box-11 .border-box-content {
  position: relative;
  width: 100%;
  height: 100%;
}
